...
import cv2
# glob modulu dosya desenleri ile calismak icin kullaniliyor
import glob
...
# Eslenen UIO bellek boyutu 0x1000 olarak tanimlaniyor
size = 0x1000
...
# Donanima gonderilecek goruntuler icin liste olusturuluyor
images = []
...
for bmp_file in bmp_files:
    ...
    # Goruntu 224x224 piksele yeniden boyutlandiriliyor
    ...
    # Kanallar birlestirilerek goruntu listeye ekleniyor
...
with open('shared.mem', "wb") as f:
        ...
        # Dosya boyutu olusmasi icin bir byte yaziliyor
...
# Imagenet sinif listesi okunuyor
...
while True:
    ...
    time.sleep(0.5)
    # Paylasimli bellekten okunan ham cikti yazdiriliyor
    print(output_map)
    # En olasi sinif etiketi yazdiriliyor
